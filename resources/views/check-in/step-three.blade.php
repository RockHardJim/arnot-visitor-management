        ...
        <div class="chat-body">
            ...
            <div class="chat-content  py-3 px-lg-8">
                <form id="myForm" class="form-horizontal" role="form"  method="POST" action="{{ route('check-in.step-three.next') }}" >
                    ...
                    <div class="row">
                        <div class="col-md-12 my-3">
                            <div style="margin: auto" align="center">
                                <video width="300" height="300" id="videos" style="border:5px solid #d3d3d3;" autoplay></video>
                                <canvas id="canvas" width="300" height="300" style="border:5px solid #d3d3d3;"></canvas>
                    ...
                    <div>
                    <H2 class = "align-center">Guidelines Pertaining To Gate Access Card Photograph</H2>
