    ...
    <div class="chat">
        ...
        <div class="chat-body">
            ...
            <div class="chat-content  py-3 px-lg-4">
                {!! Form::open(['route' => 'admin.bookings.step-two.next','method' => 'post', 'class' => 'form-horizontal', 'files' => true]) !!}
                {{ csrf_field() }}
                <div class="form-row">
                ...
                <div class="chat-footer border-top py-4 py-lg-6 px-lg-2">
                    <div class="form-row align-items-center">
                        <div class="col">
                            <a href="{{ route('admin.bookings.create') }}" class="btn btn-lg btn-sm btn-danger float-left text-white">
