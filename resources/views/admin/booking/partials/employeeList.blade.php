        ...
        <div class="card mb-4 shadow-sm user-box">
            <label>
                ...
                @if($employee->user->getFirstMediaUrl('users'))
                    <img class="bd-placeholder-img card-img-top"  src="{{ asset($employee->user->getFirstMediaUrl('users')) }}" alt="">
                @else
                    <img class="bd-placeholder-img card-img-top"  src="{{ asset('assets/images/avatars/11.jpg') }}"  alt="profile picture">
                @endif
            </label>
